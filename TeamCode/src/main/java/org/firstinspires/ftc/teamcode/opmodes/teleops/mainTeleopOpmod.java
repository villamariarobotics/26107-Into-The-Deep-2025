...
//    ExtentionArmSubsystem extention_arm = new ExtentionArmSubsystem();
...
//        extention_arm.initialize(hardwareMap);
...
//        ExtentionArmSubsystem.extendArm(gamepad2.right_stick_y);
